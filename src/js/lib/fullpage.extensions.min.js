! function (e, t, n, o, r) {
  ...
  return Ut.NodeList && !NodeList.prototype.forEach && (NodeList.prototype.forEach = function (e, t) {
      ...
      function (e, g) {
          ...
          function ze(e, t, n) {
              if (null != e) {
                  ...
                  if (!(i.activeSection == e && !E || g.scrollBar && eo() === i.dtop && !zn(e, dn))) {
                      ...
                      jt("parallax", "apply", i),
                      jt("cards", "apply", i),
                      g.autoScrolling && g.continuousVertical && void 0 !== i.isMovementUp && (!i.isMovementUp && "up" == i.yMovement || i.isMovementUp && "down" == i.yMovement) && ((s = i).isMovementUp ? qn(Rn(sn)[0],
                      co(s.activeSection, an)) : $n(Rn(sn)[0], uo(s.activeSection, an).reverse()),
                      ...
                      ro(Rn(Jt)[0], "onContinuousVertical", s), i = s),
                      ...
                      Gn(e, nn),
                      Fn(to(e), nn),
                      De(e), g.scrollOverflow && g.scrollOverflowHandler.onLeave(),
                      x = S.test.isTesting, Lt(r, o, i.anchorLink, i.sectionIndex),
                          function (e) {
          ...
          function Je(e) {
              Y = _t.createElement("div"), W = '', Y.innerHTML = W, Y = Y.firstChild, "MutationObserver" in Ut && new MutationObserver(_e).observe(_t.body, {
          ...
          function st(e, t, n) {
              ...
              r.xMovement = St(r.prevSlideIndex, r.slideIndex),
                  ...
                  jt("cards", "apply", r),
                  g.onSlideLeave && !r.localIsResizing && "none" !== r.xMovement && oo(g.onSlideLeave) && !1 === Be("onSlideLeave", r) ? a = !1 : (Gn(t, nn), Fn(to(t), nn), r.localIsResizing || (Ze(r.prevSlide), De(t)), ct(r), zn(o, nn) && !r.localIsResizing && Lt(r.slideIndex, r.slideAnchor, r.anchorLink, r.sectionIndex), S.continuousHorizontal && S.continuousHorizontal.apply(r), Wt() ? ut(r) : dt(e, r, !0), g.interlockedSlides && S.interlockedSlides && (Nt("continuousHorizontal") && void 0 !== n && n !== r.xMovement || S.interlockedSlides.apply(r)))
          }
          ...
          function Dt() {
              t || zn(Rn("html"), en) ? Hn("error", "Fullpage.js can only be initialized once and you are doing it multiple times!") : (g.continuousVertical && (g.loopTop || g.loopBottom) && (g.continuousVertical = !1, Hn("warn", "Option `loopTop/loopBottom` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled")), !g.scrollOverflow || !g.scrollBar && g.autoScrolling || Hn("warn", "Options scrollBar:true and autoScrolling:false are mutually exclusive with scrollOverflow:true. Sections with scrollOverflow might not work well in Firefox"), !g.continuousVertical || !g.scrollBar && g.autoScrolling || (g.continuousVertical = !1, Hn("warn", "Scroll bars (`scrollBar:true` or `autoScrolling:false`) are mutually exclusive with `continuousVertical`; `continuousVertical` disabled")), g.scrollOverflow && null == g.scrollOverflowHandler && (g.scrollOverflow = !1, Hn("error", "The option `scrollOverflow:true` requires the file `scrolloverflow.min.js`. Please include it before fullPage.js.")), g.anchors.forEach(function (t) {
